...
atr_indicator = volatility.AverageTrueRange(
    high=high, low=low, close=close, window=args.atr_period
)
...
output_filename = os.path.join(
    args.output_dir,
    Path(args.input_csv).stem + f"_w{args.window}_f{args.future}.onnx"
)
...
onnx.save(onx, args.output_filename)

print("Model saved at:", output_filename)
