...
def parse_args():
    ...
    parser.add_argument('--ema-period', type=int, default=20, help='Fast EMA period')
...
class SimpleEMAStrategy(Strategy):
    ...
    def init(self):
        ...
        self.ema_line = self.I(talib.EMA, close, self.ema_period)
        self.entry_pattern = []
    ...
    def next(self):
        ...
        ema_rising = self.ema_line[-1] > self.ema_line[-2]
        ema_falling = self.ema_line[-1] < self.ema_line[-2]
