...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train a buy-only RandomForest classifier and export ONNX from OHLC CSV.",
    ...
    parser.add_argument("--forward", type=int, default=10, help="Forward bars used for buy label")
...
# Target: buy if close[t + forward] > close[t]
